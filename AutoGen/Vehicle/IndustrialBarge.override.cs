...
/*
 * Industrial Barge Override by Deepflame - Barge Industries
 * 
 * This adds the functionality needed to the Industrial Barge.
 */

namespace Eco.Mods.TechTree
{
	using DF.BargeIndustries;
    ...
    [AllowPluginModules(Tags = new[] { "ModernUpgrade" }, ItemTypes = new[] { typeof(OilDrillingUpgradeItem), typeof(MiningModernUpgradeItem) })] //noloc
    ...
    [RequireComponent(typeof(BargeIndustryStatusComponent))]
